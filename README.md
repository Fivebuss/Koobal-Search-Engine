...
**v0.8.5.2** - predictive suggestions for the stock VAB/SPH parts search bar.
...
Attaches a dropdown under the native search field. Does not replace the stock parts UI.
...
4. Confirm in `KSP.log`: `[Koobal] Koobal Search Engine v0.8.5.2 active.`

## Requirements

- **KSP 1.12.x** (tested on 1.12.5)
- **[Harmony 2](https://github.com/KSPModdingLibs/HarmonyKSP/releases)** - `GameData/000_Harmony/` must be present

Do **not** install alongside **Koobal Native Search** (or other mods that replace/hijack the same stock search bar).

## Downloads

- [Releases](https://github.com/timbrwolf1121-cpu/Koobal-Search-Engine/releases) - player GameData zip
- Courtesy source snapshot: `Source/KoobalSearchEngine_v0.8.5.2_SOURCE.zip`
